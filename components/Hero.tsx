...
import course1 from "../../../public/images/courseimages/course1.jpg"
import course2 from "../../../public/images/courseimages/course2.jpg"
import course3 from "../../../public/images/courseimages/course3.jpg"
import course4 from "../../../public/images/courseimages/course4.jpg"
import course5 from "../../../public/images/courseimages/course5.jpg"
import course6 from "../../../public/images/courseimages/course6.jpg"
import course9 from "../../../public/images/courseimages/course9.jpg"
import course10 from "../../../public/images/courseimages/course10.jpg"
import course11 from "../../../public/images/courseimages/course11.jpg";



export default function Home() {
  return (
    <div className="h-[4250px]">
    <div className="flex flex-row items-center justify-between relative bg-[#FFFFFF]">
    
      <div className="h-auto w-1/2 pt-8">
        <h1 className="text-6xl font-extrabold font-sans tracking-wider whitespace-nowrap text-[64px] text-[#044E83] ml-16 mt-28 ">Governer Sindh</h1>
      ...
      <div className=" w-1/2 ml-48 flex ">
      <Image src={hero} alt="hero-image" width={1500} height={1212}></Image>
      </div>
    </div>
     {/* detail section */}
